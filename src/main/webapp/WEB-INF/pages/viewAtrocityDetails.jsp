  ...
  ============================-->
    ...
    background-image: linear-gradient(to left, #6b59cabf, #05246b00 20%, #e91e1e00 82%, #6858c8b8); color: white;" >
		...
		<td  align="center"  >${alt.entry }</td>
			<td align="center" ><a href="${pageContext.request.contextPath}/petition/atrocity/filepetion.atrocity/${alt.petionerId }" target="content"> <button class="btn btn-success btn-sm"  >Proceed to file Petition</button></a></td>
		</tr>
		</c:forEach>
		</tbody>
		</table>
