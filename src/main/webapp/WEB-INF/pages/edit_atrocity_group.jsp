            ...
            <div class="panel with-nav-tabs panel-primary">
                <div class="panel-heading">
                        <ul class="nav nav-tabs" style="font-weight: bold;">
                            <li class="active"><a href="#tab3primary" data-toggle="tab">Nodal Officer Details</a></li>
                            <li ><a href="#tab2primary" data-toggle="tab">Joint Petitioner Details</a></li>
						...
						<div class="row">
							<div class="col-sm-7 col-md-offset-2 form-group">
								<label class="col-md-6">Upload Signature of the nodal person<span
									class="star">*</span></label>
								<div class="col-md-4">
									<input type=file class="form-control SelectStyle" id="nodalfile" 
										name="file" onchange="validSign('nodalfile')">
								</div>
...
<form:input path="offence_date" value="${updateatrocity.offence_date}" id="offence_date" placeholder="" class="form-control" type="date"/>
												...
												<div
													...
													<div
														...
														<form:select class="form-control SelectStyle" path="off_district"
															id="off_district" onchange="getMandals('off_district','off_mandal', '${updateatrocity.off_mandal}' )">
															<form:option value="0">--Select--
															</form:option>
												...
												<div
													...
													<div
														...
														<form:select class="form-control SelectStyle" path="ps_district"
															id="ps_district"  onchange="getMandals('ps_district','ps_mandal', '${updateatrocity.ps_mandal}' )" >
															<form:option value="0">--Select--
															</form:option>
															<c:forEach items="${district}" var="alt">
														<form:option value="${alt.distCode }">${alt.distName}
					...
					<div align="center">
						<b><div  id="warningAtr" style="color : red;" >
						</div><div  id="messageAtr" style="color : green;" ></div></b>
						<div class="btn btn-primary" id="updateAtrocity"  >
						Update</div>
					</div>
...
$(document).on('click','#updateAtrocity', function() {
	 ...
	 var fdata = new FormData(frm);
		$.ajax({
			...
			success : function(response) {
				...
				if(response=="Y"){
                    $("#messageAtr").html("Details Updated Successfully");
					}
				else{
					
                    $("#warningAtr").html("Updation failed, try again");
					}
			}
		});
...
//changing select options on load
$(document).ready(function(){
	...
	$
			.ajax({
				...
				success : function(
					...
					$('#'+mandal+'').val(mdl) //setting mandal for edit option
				}
			});
