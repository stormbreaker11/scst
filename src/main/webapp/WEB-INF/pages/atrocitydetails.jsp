                ...
                <div class="panel-body">
                    <div class="tab-content">
                        ...
                        <div class="title1"  >
												...
												<br>
                      <div class="Petition170s2" id="atrocity">
										<div class="row">
											<div
...
<div class="col-md-6">
<input name="" placeholder="" class="form-control" type="date">
</div>
</div>
</div>
										<div class="row">
										...
										<div class="row">
											...
											<div class="col-md-offset-2 form-group " style="color: red;">allowed .pdf file of 1 mb size
							</div>
											</div> 
