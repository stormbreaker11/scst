...
<body style="margin-right: 20px; margin-left: 20px;">
  ...
  ============================-->
		<div class="container-fluid">
		 <h1 align="center" style="color:  #2d3990;">Modify - Petition</h1>
		<form name="modify">
    ...
    background-image: linear-gradient(to left, #6b59cabf, #05246b00 20%, #e91e1e00 82%, #6858c8b8); color: white;" >
		...
		<c:otherwise>
		<td align="center" ><a class="btn btn-primary btn-sm"  href="${pageContext.request.contextPath}/modifypetition.htm/${alt.petitionerId}/${alt.petitionId}/${alt.petitionType}/${alt.petitionCat}" target="content">Edit</a></td>
		</c:otherwise>
		</c:choose>
		</tr>
		</c:forEach>
