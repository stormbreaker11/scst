	...
	<td  align="right">Petition Category : ${category}</td>
            ...
            <div class="panel with-nav-tabs panel-primary">
                ...
                <div class="panel-body">
                    <div class="tab-content"> <div class="tab-pane fade in active" id="tab2primary">
						...
						<div class="row">
							<div class="col-sm-7 col-md-offset-2 form-group">
								<label class="col-md-6">Upload Signature of the nodal person<span
									class="star">*</span></label>
								<div class="col-md-4">
									<input type=file class="form-control SelectStyle" id="nodalfile"  onchange="validSign('nodalfile')"
										name="file">
								</div>
				...
				<table align="center"><tr><td align="center"> <b><font id="message" color="green"></font></b></td></tr></table>
                    ...
                    </div><div class="tab-pane fade" id="tab3primary">
				...
				<div align="center">
				<div style="text-align: center;" class="btn btn-primary btn-sm"
			...
			<div id="petitionerdiv" >
				...
				<div>
					<table id="PetitionerTable" class="table table-bordered"
                     ...
                     <form:form modelAttribute="service" name="service">         
                
                <form:input type="hidden" name="petitioner_id" path="petitioner_id" value="${pid}"/>
                <form:input type="hidden" name="petition_id" path="petition_id" value="${petId}"/>
										<div class="row">
											<div
												...
												<div class="col-md-4">
													<form:select class="form-control SelectStyle"  path="service_type"
														...
														<c:if test="${service.service_type=='1' }">
														<form:option value="1" selected="true">
															 Appointments
														</form:option>
														<form:option value="2">
															 Promotions
														...
														<c:if test="${service.service_type=='2' }">
														<form:option value="1" >
															 Appointments
														</form:option>
														<form:option value="2" selected="true">
															 Promotions
														</form:option>
														<form:option value="3">Others
														</form:option>
														...
														<c:if test="${service.service_type=='3' }">
														<form:option value="1" >
															 Appointments
														</form:option>
														<form:option value="2" >
														...
														<form:option value="3" selected="true">Others
														</form:option>
											...
											<div
												...
												<div class="col-md-6">
													<form:textarea
														...
														id="appeal"
														cols="39"
														rows="2" value="${service.appeal }" ></form:textarea>
												</div>
											</div>
										</div>
										<div class="row">
											<div
												...
												<div class="col-md-6">
													<form:textarea
														...
														rows="7" value="${service.pet_detail }"></form:textarea>
												</div>
											</div>
										</div>
                   ...
                   <div align="center">
                    ...
                    <input type="button" value="Update" id="updateService" class="btn btn-primary">
...
<div align="center" style="background: #2d3990; color: white; height: 30px; ">
										...
										<input type="hidden" value="${petId}"  >
											...
											<div align="center"><input type="button" class="btn btn-md btn-primary" id="savebtn" style="display:none;" value="Continue" onclick="proceed()"></div></form:form>				
						...
						$("#signfile").val('')
						 if(response=="N")
							...
							return false;
								...
								k = $('#PetitionerTable tr:last-child td:nth-child(2)').html();
										if(row==1){
											 $('#saveBtn').show();
											 $('#petitionerdiv').show();
											}
			...
			var form = $('#service').serialize();
				...
				$.ajax({
					...
					success : function(response) {
						...
						if(response=="Y"){
		                    $("#tab1primary #message").html("Details Updated Successfully");
							}
						else{
		                    $("#tab1primary #warning").html("Updation failed, try again");
							}
					}
				});
